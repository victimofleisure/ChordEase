...
PARTMIDITARGETDEF(	INPUT_ZONE_LOW,			Input)
PARTMIDITARGETDEF(	INPUT_ZONE_HIGH,		Input)
PARTMIDITARGETDEF(	INPUT_TRANSPOSE,		Input)
PARTMIDITARGETDEF(	INPUT_VEL_OFFSET,		Input)
PARTMIDITARGETDEF(	INPUT_NON_DIATONIC,		Input)
PARTMIDITARGETDEF(	INPUT_NOTE,				Input)
