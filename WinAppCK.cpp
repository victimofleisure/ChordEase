...
bool CWinAppCK::GetIconSize(HICON Icon, CSize& Size)
{
	ICONINFO	IconInfo;
...
void CWinAppCK::UpdateAllViews(CView* pSender, LPARAM lHint, CObject* pHint)
{
...
bool CWinAppCK::DeleteDirectory(LPCTSTR lpszDir, bool bAllowUndo)
{
...
void CWinAppCK::FixMFCDotBitmap()
{
...
HBITMAP CWinAppCK::GetMFCDotBitmap()
{
...
void CWinAppCK::DockControlBarLeftOf(CFrameWnd *Frame, CControlBar *Bar, CControlBar *LeftOf)
{
	UINT n = 0;
	CRect	rect, pRect;
	if (LeftOf != NULL) {
...
void CWinAppCK::UpdateMenu(CWnd *pWnd, CMenu *pMenu)
{
	CCmdUI	cui;
	cui.m_pMenu = pMenu;
...
CString CWinAppCK::FormatSystemError(DWORD ErrorCode)
{
	LPTSTR	lpszTemp;
